				...
				<div class="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
					{#each rooms as room (room.id)}
						...
						<details class="group rounded-3xl border border-slate-200 bg-slate-50 p-4">
							<summary
								class="list-none cursor-pointer rounded-[26px] bg-white p-4 text-left shadow-sm ring-1 ring-slate-200 transition hover:bg-slate-50"
							>
								<div class="flex items-center justify-between gap-4">
									<div class="min-w-0">
										...
										<div class="mt-2 flex flex-wrap gap-1.5">
											...
											{#if roomParticipants.length > 0}
												...
												>
													{roomParticipants
														.map((participant, index) => getParticipantName(participant, index))
														.join(', ')}
												</div>
											{/if}
										</div>
									...
									<div class="flex shrink-0 items-center gap-3">
										...
										<div
											class="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-100 text-[18px] font-black text-slate-500 transition group-open:bg-blue-600 group-open:text-white"
										>
							...
							<div class="mt-3">
								...
								<div class="mt-3 rounded-2xl border border-slate-200 bg-white p-3">
									<div class="flex items-center justify-between gap-2">
										<div class="text-[13px] font-black text-slate-800">현재 입장한 학생</div>
									...
									{:else}
										<div
											class="mt-3 rounded-xl bg-slate-50 px-3 py-3 text-[12px] font-bold text-slate-400"
										>
											아직 입장한 학생이 없습니다.
										</div>
									{/if}
								...
								{#if isReadCourse}
									...
									<div class="mt-3 rounded-2xl border border-violet-100 bg-violet-50 p-3">
										<div class="flex items-center justify-between gap-3">
											<div>
												<div class="text-[13px] font-black text-violet-800">
													읽기 미션 제출 확인
												</div>
