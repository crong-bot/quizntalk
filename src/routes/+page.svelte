...
<div class="w-1280 m-auto">
	...
	<main class="">
		<div id="landing_wrapper" class="flex flex-col">
			<div class="flex flex-row justify-between items-center h-screen pb-28">
				<div class="flex flex-col justify-center items-start ml-28">
					<!--<h2 class="font-dongle font-bold text-9xl leading-8">STEP.AI</h2> -->
					<!-- -space-y-5 -->
					<div
						id="landingtitle"
						class="flex flex-col font-dodum font-extrabold text-6xl tracking-normal"
					>
						<h1 class=" ">QuizNTalk으로</h1>
						<h1 class="">인공지능의 원리를</h1>
						<h1 class="pt-3">쉽게 배워보세요.</h1>
					</div>

					<p class="font-dodum font-normal text-base leading-7 mt-14">
						QuizNTalk는 채팅인터페이스에 익숙한 학생들을 위한 교육도구입니다.
					</p>
					<p class="font-dodum font-normal text-base leading-7">
						AI 및 소프트웨어뿐만 아니라 다양한 분야를 배울 수 있습니다.
					</p>
					<p class="font-dodum font-normal text-base leading-7">
				...
				<div>
					<img class="object-none" src="/landing1.webp" alt="landing" width="704" height="555" />
				</div>
			</div>

			<div class="flex flex-row justify-around items-center h-screen">
				<div>
					<img class="object-none" src="/landing2.webp" alt="landing" width="901" height="796" />
				</div>
				<div class="flex flex-col justify-center items-start">
					<div class="flex flex-col font-dodum font-extrabold text-6xl tracking-normal">
						<h1 class=" ">자신만의</h1>
						<h1 class="">수업을 만들어</h1>
						<h1 class="pt-4">공유할 수 있습니다.</h1>
					</div>
					<p class="font-dodum font-normal text-base leading-7 mt-14">
						채팅방식의 다이얼로그를 작성해서.
					</p>
