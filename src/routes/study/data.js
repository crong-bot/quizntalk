export const posts = [
	...
	// 	adress: 'cognitive',
	// 	image: '/heart.png',
	// 	list: ['사람과 인공지능의 인식 차이 ', '인공지능이 인식하는 방법'],
	...
	// 		{
	// 			type: 'chat1',
	// 			dial: '음..그냥 사진을 보고 고양이가 떠올랐어요.',
	// 			choice: '',
	// 			quiztype: ''
	// 		},
	// 		{
	// 			type: 'chat2',
	// 			dial: '그렇다면 인공지능은 눈이 없는데 어떻게 사진을 파악할까요?',
	// 			choice: '',
	// 			quiztype: ''
	// 		},
	...
	// 		{
	// 			type: 'chat2',
	// 			dial: '그럼 인공지능은 인간처럼 뇌가 없는데 어떻게 사진을 바로 고양이라고 알까요?',
	// 			choice: '',
	// 			quiztype: ''
	// 		}
	// 	]
	...
	},
	{
		...
		steps: [
			...
			{ kind: 'chat', role: 'student', text: ' 모르겠스비낟.?' }
		]
	}
	...
	// 		{
	// 			type: 'chat2',
	// 			dial: '...좋아요. 일단 인공지능이 인간과 같은 뇌는 없죠?',
	// 			choice: '',
	// 			quiztype: ''
	// 		},
	...
	// 		{
	// 			type: 'chat2',
	// 			dial: '그럼 인공지능이 사진을 인식하는 방법은 사람과는 같지 않겠죠?',
	// 			choice: '',
	// 			quiztype: ''
	// 		},
	...
	// 		{
	// 			type: 'chat2',
	// 			dial: '다음 시간에는 인공지능이 사진을 인식하는 방법이 사람과 어떻게 다른지 알아볼거에요!',
	// 			choice: '',
	// 			quiztype: ''
	// 		}
	// 	]
