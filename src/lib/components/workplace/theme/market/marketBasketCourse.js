...
export const marketBasketCourse = {
	...
	intro: {
		...
		summaryTitle: '현재 상황',
		summary:
			'우리 동네 마트의 비상물품 코너의 진열을 하게 됐습니다. 어떤 물건을 같이 진열하면 좋을지 영수증을 분석해서 해결해보세요!',
		goalTitle: '우리의 임무',
		missionGoal:
	...
	missions: [
...

		{
			...
			type: 'role-analysis',
			question:
				'팀원들이 분석한 장바구니를 서로 이야기하고, 우리 마트의 비상대비용품 코너에 진열할 상품 2가지를 정해보세요.',
			answerFields: [
				{
					key: '상품조합',
...
function createEmergencyDisplayMission(call) {
	return {
		story: {
			...
			call,
			summary:
				'팀원들이 분석한 장바구니를 서로 이야기하고, 우리 마트에 진열할 비상대비용품 조합을 정합니다.',
