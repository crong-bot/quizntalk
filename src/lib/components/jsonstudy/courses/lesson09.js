export const lesson09 = {
	...
	contentBlocks: [
		...
		{
			type: 'paragraph',
			parts: [{ text: '해당 2권의 정보를 JSON형태로 정리해서 AI학습에 활용할거에요.' }]
		},
		{
			type: 'paragraph',
			parts: [
		...
		{
			type: 'paragraph',
			parts: [{ text: '아래 예시 JSON를 확인해서 "도서학습데이터" 키에 값들을 넣어봅시다!' }]
		},
  ...
  "대여가능": true 
	...
	task: '위의 책 2권을 책 추천 AI가 배울 수 있는 학습 데이터로 만들어보세요. "도서학습데이터" 안에 두 책의 정보를 JSON으로 정리해보세요.',
	initialCode: `{
	"도서학습데이터":[]
}`,
	answer: {
