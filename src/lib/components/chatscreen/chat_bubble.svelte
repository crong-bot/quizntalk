...
{#if chat_direction}
	<div
       ...
       w-fit max-w-[92%] sm:max-w-[85%] md:max-w-[70%] lg:max-w-[28rem] min-w-0"
	>
...
{:else}
	<div
		...
		class="ml-auto mr-1 mt-2 mb-4 flex flex-row bg-chat rounded-r-3xl rounded-b-3xl pt-2 pb-4 pl-3 pr-4 space-x-3 font-dodum
       w-fit max-w-[92%] sm:max-w-[85%] md:max-w-[70%] lg:max-w-[28rem] min-w-0"
	>
		<div class="w-12 flex pt-3 justify-end">
			<svg
